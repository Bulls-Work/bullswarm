...
Read-only evidence report. Date: 2026-08-31. Repo checkout: `/home/dev/Repo/bullswarm`
...
```
/home/dev/.claude/skills/bullswarm -> /home/dev/.local/lib/node_modules/bullswarm/skill
/home/dev/.codex/skills/bullswarm  -> /home/dev/.local/lib/node_modules/bullswarm/skill
/home/dev/.grok/skills/bullswarm   -> /home/dev/.local/lib/node_modules/bullswarm/skill
```
...
| --- | --- | --- |
| `/home/dev/Repo/bullswarm/skill` | 5.4K | this checkout (working tree) |
| `/home/dev/.local/lib/node_modules/bullswarm/skill` | 5.1K | **what all three symlinks point at** |
| `/home/dev/.nvm/versions/node/v22.17.0/lib/node_modules/bullswarm/skill` | — | second global install, unused by the symlinks |

`which -a bullswarm` resolves `/home/dev/.local/bin/bullswarm` first, which is a
...
`/home/dev/.nvm/versions/node/v22.17.0/lib/node_modules`. Both installs report
...
"ok": false, "skillSource": "/home/dev/Repo/bullswarm/skill"
codex/claude/grok → skill.status "conflict",
                    skill.target "/home/dev/.local/lib/node_modules/bullswarm/skill",
                    awareness true
...
| --- | --- | --- | --- | --- |
| `node bin/bullswarm.js` (checkout) | `/home/dev/Repo/bullswarm/skill` | conflict ×3 | false | 1 |
| `/home/dev/.local/lib/node_modules/bullswarm/bin/bullswarm.js` | `/home/dev/.local/lib/node_modules/bullswarm/skill` | **installed ×3** | **true** | 0 |
| `/home/dev/.nvm/.../bullswarm/bin/bullswarm.js` | `/home/dev/.nvm/.../bullswarm/skill` | conflict ×3 | false | 1 |
...
```
### Skill roots
- `r0` = `/home/dev/.codex/skills`
- `r1` = `/home/dev/.agents/skills`
- `r2` = `/home/dev/.codex/skills/.system`
- `r3`..`r8` = plugin caches under /home/dev/.codex/plugins/cache/...
### Available skills
...
into `/home/dev/.local/lib/node_modules/bullswarm/skill`. 16 of the 39 entries are
...
{ "name": "bullswarm",
  ...
  "source": { "type": "user", "path": "/home/dev/.grok/skills/bullswarm/SKILL.md" },
  "userInvocable": true }
```
...
`/home/dev/.grok/Agents.md (global, ~226 tokens)` and
`/home/dev/.claude/Claude.md (global, ~935 tokens) [claude]`.

## 4. Awareness blocks

| File | Marker lines | Block identical to canonical? |
| --- | --- | --- |
| `/home/dev/.claude/CLAUDE.md` | 14–28 | yes |
| `/home/dev/.codex/AGENTS.md` | 7–21 | yes |
| `/home/dev/.grok/AGENTS.md` | 1–15 | yes |
...
- **Codex** — `codex debug prompt-input` item 3 (`role: user`) carries the header
  `# AGENTS.md instructions for /home/dev/Repo/bullswarm` and inside it the text of
  ...
  `@/home/dev/.codex/RTK.md` and the CircleCI paragraph.
...
- The clearest pair: name `status` registered from both
  `/home/dev/.claude/skills/railway-status/SKILL.md` (`"vendor": "claude"`) **and**
  `/home/dev/.cursor/skills/railway-status/SKILL.md` (`"vendor": "cursor"`), with
...
`/home/dev/.grok/skills/bullswarm/SKILL.md`. No entry anywhere in the JSON has a
source path under `/home/dev/.claude/skills/bullswarm`, even though that symlink
...
6. Behaviour was sampled with cwd `/home/dev/Repo/bullswarm` (plus one Codex run from `/tmp`, same result). Project-scoped roots (`./.grok/skills`, `./.claude/skills`) were not exercised in another repository.
