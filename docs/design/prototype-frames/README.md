...
Exact text frames of the approved dashboard prototype (docs/design/dashboard-prototype.html,
also live at https://claude.ai/artifact/K12oMk45Gh2zZvn8TM8fZc), one file per page and width:
