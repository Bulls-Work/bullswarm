...
claude-code:acme, codex, command-code, then the disabled pools. Disabled pools
...
claude-code:initech ... unmetered ... disabled
claude-code:acme weekly used 76% elapsed 92.3% [cache] surplus=16.3 inflight=0 ... resets in 12h55m EXPIRING-SOON urgency=212
