...
`[screenshot removed: it showed private project data]`. Its single
...
```text
cp -Rp /home/dev/.bullswarm /tmp/stats-design-home.XG6mba/bullswarm
...
Snapshot source: the copied 7-day rollups described above. `cc`, `acme` and
...
```text
 ...
 $2.0 ┤       ▄                                         │ acme $3.27 46.6% |  cc:acme 1,258m 17.9%
 ...
 $0.0 ┼▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄              │ cmd $0.07 1.0% | cmd-code 1,009m
      ...
      — unknown basis · ≈ byte estimate                 │ acme 74 17.4% · cmd 68 16.0%
                                                        ...
                                                        │ pool: claude-code / codex / acme
                                                        │ pool: command-code / grok / opencode
                                                        │ model: cost unavailable in rollup
                                                        │ project: project-c 20 runs
                                                        │ project: bullswarm 15 · project-a 11
...
```text
 ...
 acme $3.27 46.6% · codex $0.27 3.8%
 opencode — (cost not recorded)
 POOL MINUTES
 codex 28.4% · acme 17.9% · opencode 15.4%
 OUTCOME & DURATION
 completed 53 · partial 2 · cancelled 4
 verified 30/59 · p50 54m · max 9h03m
 By Model: model cost —
